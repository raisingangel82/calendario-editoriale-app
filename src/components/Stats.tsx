...
// ▼▼▼ MODIFICA: Import per Swiper e per la distinzione mobile/desktop ▼▼▼
...
export const Stats: React.FC<StatsProps> = ({ posts, progetti, onFilterClick }) => {
    ...
    const isDesktop = useBreakpoint(); // Hook per distinguere le viste
    ...
    // Componente per il selettore del filtro, riutilizzato in entrambe le viste
    const ProjectFilter = () => (
        <div>
    ...
    // Componente per la produzione per progetto
    ...
    // Componente per la produzione per categoria
    ...
    return (
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-4 rounded-lg h-full">
            {/* ▼▼▼ MODIFICA: Scelta del layout in base alla dimensione dello schermo ▼▼▼ */}
            {isDesktop ? (
                // LAYOUT DESKTOP
                    ...
                    <div className="lg:col-span-2 lg:border-l lg:pl-6 border-gray-200 dark:border-gray-700 space-y-4">
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6">
                            <div className="space-y-4">
                                {/* Filtro spostato qui per la vista desktop */}
                                <ProjectFilter />
                                <ProduzioneCategoria />
                            </div>
                            <div>
                ...
                <>
                    {/* Aggiungiamo stili per i pallini di paginazione */}
                    <style>{`
                    ...
                    >
                        ...
                        <SwiperSlide>
                            <div className="p-1 pb-8 space-y-4">
                                {/* Filtro qui per la seconda pagina mobile */}
                                <ProjectFilter />
                                <ProduzioneCategoria />
                            </div>
                        </SwiperSlide>
